  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payment" do
        ...
        Payment.any_instance.should_receive(:update_attributes).with({ "payer_id" => "1" })
        put :update, {:id => payment.to_param, :payment => { "payer_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payment as @payment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Payment.any_instance.stub(:save).and_return(false)
        put :update, {:id => payment.to_param, :payment => { "payer_id" => "invalid value" }}, valid_session
        assigns(:payment).should eq(payment)
      end
